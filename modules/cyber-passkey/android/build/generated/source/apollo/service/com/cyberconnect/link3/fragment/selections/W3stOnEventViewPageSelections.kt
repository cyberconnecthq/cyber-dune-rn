...
import com.cyberconnect.link3.type.V3W3STContractInfo
...
public object W3stOnEventViewPageSelections {
  ...
  private val __v3contractInfo: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          name = "deployStatus",
          type = W3STDeployStatus.type.notNull()
        ).build(),
  ...
  public val __root: List<CompiledSelection> = listOf(
        ...
        CompiledField.Builder(
          name = "v3contractInfo",
          type = V3W3STContractInfo.type.notNull().list()
        ).selections(__v3contractInfo)
        .build(),
        CompiledField.Builder(
          name = "requirements",
