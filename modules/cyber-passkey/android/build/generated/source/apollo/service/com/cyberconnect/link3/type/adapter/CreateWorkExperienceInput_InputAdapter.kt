...
public object CreateWorkExperienceInput_InputAdapter : Adapter<CreateWorkExperienceInput> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      CreateWorkExperienceInput = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: CreateWorkExperienceInput,
  ): Unit {
