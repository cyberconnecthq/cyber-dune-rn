...
public object GetPostCommentReplyQuerySelections {
  ...
  private val __comment: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          name = "commentCount",
          type = GraphQLInt.type.notNull()
        ).build(),
  ...
  public val __root: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          ...
          CompiledArgument.Builder("commentId", CompiledVariable("commentId")).build()
        ))
        .selections(__comment)
        .build()
      )
}
