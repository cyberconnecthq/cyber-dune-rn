...
public object CreateBlockInput_InputAdapter : Adapter<CreateBlockInput> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      CreateBlockInput = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: CreateBlockInput,
  ): Unit {
    ...
    if (value.event is Optional.Present) {
      writer.name("event")
      EventCreation_InputAdapter.obj().nullable().present().toJson(writer, customScalarAdapters,
          value.event)
    }
    if (value.post is Optional.Present) {
      writer.name("post")
      PostCreation_InputAdapter.obj().nullable().present().toJson(writer, customScalarAdapters,
          value.post)
    }
