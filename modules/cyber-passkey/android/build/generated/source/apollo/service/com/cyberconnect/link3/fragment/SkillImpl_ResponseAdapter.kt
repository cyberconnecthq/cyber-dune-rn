...
public object SkillImpl_ResponseAdapter {
  public object Skill : Adapter<com.cyberconnect.link3.fragment.Skill> {
    public val RESPONSE_NAMES: List<String> = listOf("__typename", "hasRead", "id", "timestamp",
        "type", "content", "from")

    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        com.cyberconnect.link3.fragment.Skill {
      var __typename: String? = null
      var _hasRead: Boolean? = null
      var _id: String? = null
      var _timestamp: Any? = null
      var _type: NotificationType? = null
      var _content: com.cyberconnect.link3.fragment.Skill.Content? = null
      var _from: com.cyberconnect.link3.fragment.Skill.From? = null
      ...
      return com.cyberconnect.link3.fragment.Skill(
    ...
    public override fun toJson(
      ...
      `value`: com.cyberconnect.link3.fragment.Skill,
    ): Unit {
  ...
  public object Content : Adapter<com.cyberconnect.link3.fragment.Skill.Content> {
    public val RESPONSE_NAMES: List<String> = listOf("endorsed", "endorserCount", "id", "name")

    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        com.cyberconnect.link3.fragment.Skill.Content {
      ...
      while(true) {
        when (reader.selectName(RESPONSE_NAMES)) {
          ...
          1 -> _endorserCount = IntAdapter.fromJson(reader, customScalarAdapters)
          2 -> _id = StringAdapter.fromJson(reader, customScalarAdapters)
      ...
      return com.cyberconnect.link3.fragment.Skill.Content(
        endorsed = _endorsed!!,
    ...
    public override fun toJson(
      writer: JsonWriter,
      customScalarAdapters: CustomScalarAdapters,
      `value`: com.cyberconnect.link3.fragment.Skill.Content,
    ): Unit {
  ...
  public object From : Adapter<com.cyberconnect.link3.fragment.Skill.From> {
    public val RESPONSE_NAMES: List<String> = listOf("lightInfo")

    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        com.cyberconnect.link3.fragment.Skill.From {
      var _lightInfo: com.cyberconnect.link3.fragment.Skill.LightInfo? = null
      ...
      return com.cyberconnect.link3.fragment.Skill.From(
    ...
    public override fun toJson(
      writer: JsonWriter,
      customScalarAdapters: CustomScalarAdapters,
      `value`: com.cyberconnect.link3.fragment.Skill.From,
    ): Unit {
  ...
  public object LightInfo : Adapter<com.cyberconnect.link3.fragment.Skill.LightInfo> {
    public val RESPONSE_NAMES: List<String> = listOf("avatar", "displayName", "handle", "profileId")

    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        com.cyberconnect.link3.fragment.Skill.LightInfo {
      ...
      return com.cyberconnect.link3.fragment.Skill.LightInfo(
        avatar = _avatar!!,
    ...
    public override fun toJson(
      writer: JsonWriter,
      customScalarAdapters: CustomScalarAdapters,
      `value`: com.cyberconnect.link3.fragment.Skill.LightInfo,
    ): Unit {
      writer.name("avatar")
