...
public object SearchOrgsQuery_VariablesAdapter : Adapter<SearchOrgsQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      SearchOrgsQuery = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: SearchOrgsQuery,
  ): Unit {
    if (value.text is Optional.Present) {
      writer.name("text")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.text)
    }
