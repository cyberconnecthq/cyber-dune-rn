...
public object GetRegistrantsQuery_VariablesAdapter : Adapter<GetRegistrantsQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      GetRegistrantsQuery = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: GetRegistrantsQuery,
  ): Unit {
    writer.name("id")
